...
Label(root, text='akasharma._', bg='#4a536b', fg='#ff9a8d', font='Times 15 bold italic').pack()
...
Label(root, text='URl Shortener here (copy and paste on browser tab)', bg='#4a536b', fg='#aed6dc',
